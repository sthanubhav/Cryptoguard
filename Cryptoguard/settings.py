...
"""
Django settings for Cryptoguard project.
...
SECRET_KEY = 'django-insecure-oq7-bdwm@z&&ejyj$=3e-1s4r3^4udvr4sv(ip7arkhwritg*7'
...
WSGI_APPLICATION = 'Cryptoguard.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'OPTIONS':  {
            'ssl': {'ca': 'Cert/nettrust-db.crt.pem',
            }
        }
    }
}
...
LOGGING = {
    ...
    'handlers': {
        'db_log': {
            'level': 'DEBUG',
            'class': 'UI.db_log_handler.DatabaseLogHandler'
        },
    },
    'loggers': {
        'db': {
